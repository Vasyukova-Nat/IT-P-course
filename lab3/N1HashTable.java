...
public class N1HashTable<K, V> { // параметры типов K и V, где K — это тип ключа, а V — тип значения
    ...
    public N1HashTable(int capacity) { // Конструктор класса HashTable принимает аргумент capacity, который задает
